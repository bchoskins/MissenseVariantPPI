...
n_epochs=50
batch_size = 256
adam = Adam(lr=0.01, amsgrad=True, epsilon=1e-6) 
...
cp = keras.callbacks.ModelCheckpoint(filepath="/Dedicated/jmichaelson-wdata/rotating_students/bhoskins/ProteinData/SeqModel_2.h5",
...
hist_df.to_csv("/Dedicated/jmichaelson-wdata/rotating_students/bhoskins/ProteinData/history2.csv")