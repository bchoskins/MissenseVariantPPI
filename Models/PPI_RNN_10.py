...
cp = keras.callbacks.ModelCheckpoint(filepath="/Dedicated/jmichaelson-wdata/rotating_students/bhoskins/ProteinData/SeqModel_10.h5",
...
for train, test in train_test:
  ...
  sgd = SGD(lr=0.001, momentum=0.0, nesterov=False)
  merge_model.compile(optimizer=sgd, loss='mse', metrics=['accuracy'])
...
hist_df.to_csv("/Dedicated/jmichaelson-wdata/rotating_students/bhoskins/ProteinData/history10.csv")